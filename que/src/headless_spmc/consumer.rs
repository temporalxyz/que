...
impl<T: AnyBitPattern, const N: usize> Consumer<T, N> {
    ...
    /// Joins an existing channel back by shared memory as a consumer.
    ///
    /// `interval` is the number of consumers. This channel is not FIFO! To consume all produced values, you must consume all values generated by all consumers generated via `next_multi`.
